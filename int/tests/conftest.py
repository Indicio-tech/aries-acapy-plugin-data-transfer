...
from acapy_client.models.connection_static_request import (
    ConnectionStaticRequest,
)
from acapy_client.models.connection_static_result import (
...
@pytest.fixture(scope="session")
def echo_seed():
    yield hashlib.sha256(b"acapy-plugin-data-transfer-int-test-runner").hexdigest()[:32]


@pytest.fixture(scope="session")
def agent_seed():
    yield hashlib.sha256(b"acapy-plugin-data-transfer").hexdigest()[:32]
